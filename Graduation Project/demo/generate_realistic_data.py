...
# 备用图片URL（如果Unsplash无法访问）
BACKUP_IMAGES = [
    'https://via.placeholder.com/400x300/667eea/ffffff?text=Electronic+Device',
    'https://via.placeholder.com/400x300/764ba2/ffffff?text=Laptop',
    'https://via.placeholder.com/400x300/f6e05e/ffffff?text=Tablet',
    'https://via.placeholder.com/400x300/e67e22/ffffff?text=Headphones',
    'https://via.placeholder.com/400x300/3498db/ffffff?text=Books',
    'https://via.placeholder.com/400x300/9b59b6/ffffff?text=Lamp',
    'https://via.placeholder.com/400x300/2ecc71/ffffff?text=Fitness',
    'https://via.placeholder.com/400x300/e74c3c/ffffff?text=Sports',
    'https://via.placeholder.com/400x300/34495e/ffffff?text=Study+Supplies',
    'https://via.placeholder.com/400x300/95a5a6/ffffff?text=Watch',
]
...
def generate_placeholder_image(text, filename):
    """生成占位符图片"""
    try:
    ...
    for category_data in CATEGORIES:
        try:
            ...
            for product_data in category_data['products']:
                ...
                image_path = download_image(random.choice(PRODUCT_IMAGES), image_filename)
                
                # 如果下载失败，生成占位图
                if not image_path:
                    image_path = generate_placeholder_image(product_data['title'], image_filename)
